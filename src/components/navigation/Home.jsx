      ...
      <section className="py-14">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="feature-cards-container">
            ...
            {/* Dados Educacionais */}
            <div 
              className="feature-card p-8 rounded-xl shadow-lg border-2 border-purple-500 cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 text-center" 
              style={{ backgroundColor: 'var(--background-color)' }}
              onClick={() => navigate('/dados-educacionais/basica')}
            >
              <div className="bg-purple-100 w-16 h-10 rounded-full flex items-center justify-center mx-auto mb-6">
