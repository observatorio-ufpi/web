...
import { FaArrowLeft, FaBars, FaGraduationCap, FaInfoCircle, FaTimes, FaDollarSign, FaChartLine, FaChartPie } from 'react-icons/fa';
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-2">
              ...
              <li>
                ...
                >
                  <FaChartPie className="mr-3 text-lg flex-shrink-0" />
              ...
              <li>
                ...
                >
                  <FaChartLine className="mr-3 text-lg flex-shrink-0" />
